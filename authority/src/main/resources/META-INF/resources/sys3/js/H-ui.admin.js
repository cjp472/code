...
function Hui_admin_tab(obj){
	...
	if(!bStop){
		creatIframe(href,title,mid?mid:'');
		min_titleList();
	}
	else{
...
/*创建iframe*/
function creatIframe(href,titleName,mid){
	var topWindow=$(window.parent.document),
		show_nav=topWindow.find('#min_title_list'),
		iframe_box=topWindow.find('#iframe_box'),
	...
	iframeBox.hide();
	iframe_box.append('<div class="show_iframe"><div class="loading"></div><iframe frameborder="0" src='+href+' data-mid='+mid+'></iframe></div>');
